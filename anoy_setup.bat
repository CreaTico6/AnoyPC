...
ECHO arrMessages(8) = "System resources are critically low. Please execute 5 pushups! Close all non-essential applications." >> "%TARGET_DIR%\%VBS_FILE%"
...
ECHO arrMessages(10) = "Critical process 'WhatDoesTheFoxSay.exe' has failed. All user sessions must be terminated. (Click OK to continue the deception)." >> "%TARGET_DIR%\%VBS_FILE%"
